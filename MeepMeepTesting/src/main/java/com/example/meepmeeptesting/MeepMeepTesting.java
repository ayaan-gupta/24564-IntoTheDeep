...
//                        .setTangent(Math.toRadians(90))
                        ...
                        .back(6)
                        .setTangent(Math.toRadians(90))
                        .splineToLinearHeading(new Pose2d(9, -34, Math.toRadians(270)), Math.toRadians(90))
                        .setTangent(Math.toRadians(270))
                        .splineToLinearHeading(new Pose2d(49, -62, Math.toRadians(90)), Math.toRadians(270))
                        .waitSeconds(.25)
//                        .back(6)
                        .setTangent(Math.toRadians(90))
                        .splineToLinearHeading(new Pose2d(9, -34, Math.toRadians(270)), Math.toRadians(90))
                        .setTangent(Math.toRadians(270))
                        .splineToLinearHeading(new Pose2d(49, -56, Math.toRadians(90)), Math.toRadians(270))
                        .waitSeconds(.25)
                        .back(6)
                        .setTangent(Math.toRadians(90))
                        .splineToLinearHeading(new Pose2d(9, -34, Math.toRadians(270)), Math.toRadians(90))
